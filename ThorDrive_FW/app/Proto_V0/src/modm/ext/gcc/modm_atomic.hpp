...
extern "C" [[gnu::always_inline]] inline uint8_t
...
__atomic_fetch_and_1(volatile void *ptr, uint8_t value, int memorder)
{
	...
	{
		modm::atomic::Lock _;
		previous = *reinterpret_cast<volatile uint8_t*>(ptr);
...
extern "C" [[gnu::always_inline]] inline uint16_t
...
__atomic_fetch_and_2(volatile void *ptr, uint16_t value, int memorder)
{
	...
	{
		modm::atomic::Lock _;
		previous = *reinterpret_cast<volatile uint16_t*>(ptr);
...
extern "C" [[gnu::always_inline]] inline uint32_t
...
__atomic_fetch_and_4(volatile void *ptr, uint32_t value, int memorder)
{
	...
	{
		modm::atomic::Lock _;
		previous = *reinterpret_cast<volatile uint32_t*>(ptr);
