...
function(modm_targets_create project_name)
  ...
  add_custom_command(TARGET size
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.size ${PROJECT_BINARY_DIR}/${project_name}.elf \"[]\"
  ...
  add_custom_command(TARGET program-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.jlink -device atmega328p-au
        ${PROJECT_BINARY_DIR}/${project_name}.elf
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET reset-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.jlink -device atmega328p-au --reset
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET log-itm-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.itm jlink -device atmega328p-au
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET log-rtt-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.rtt --channel ${MODM_RTT_CHANNEL} jlink -device atmega328p-au
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
endfunction()
